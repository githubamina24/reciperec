...
def main():
    ...
    st.markdown(
        "A Recipe Recommendaton system<a href='https://github.com/jackmleitch/whatscooking-deployment'><img src='https://upload.wikimedia.org/wikipedia/commons/thumb/9/91/Octicons-mark-github.svg/600px-Octicons-mark-github.svg.png' width='20' height='20'></a> ",
        unsafe_allow_html=True,
    )

    st.markdown(
        "## Given a list of ingredients, what different recipes you can make with em? :tomato: "
    )

    st.markdown(
        "For example, say I want to use up the leftover ingredients at home this ML based model will look through over 15000 recipes to find matches for you... :mag: Try it out for yourself below! :arrow_down:"
    )
    ...
    if session_state.model_computed:
        ...
        recipe_all_box = st.selectbox(
            "See the top recommendations or pick a particular recipe ya fancy",
